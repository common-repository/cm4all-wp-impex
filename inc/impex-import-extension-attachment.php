...
class __AttachmentImporter
{
  ...
  protected ImpexImportTransformationContext $transformationContext;
  protected $url_remap = [];

  function __construct(array $slice, array $options, ImpexImportTransformationContext $transformationContext)
  {
      $this->slice = $slice;
