...
abstract class ImpexPart
{
  ...
  public function getProvider(string $name): ?\cm4all\wp\impex\ImpexProvider
  {
  ...
  public function removeProvider(string $name): ?\cm4all\wp\impex\ImpexProvider
  {
  ...
  public function getProfile(string $name): ?\cm4all\wp\impex\ImpexProfile
  {
    return $this->_profiles->get($name);
  }

  public function removeProfile(string $name): ?\cm4all\wp\impex\ImpexProfile
  {
